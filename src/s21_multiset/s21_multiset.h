...
public:
    ...
    template <class... Args>
    std::vector<std::pair<typename set<K,Comp>::iterator, bool>> insert_many(Args&&... args);
    std::pair<typename set<K,Comp>::iterator, bool> insert(const value_type& value) override;
