...
TEST(map_end, case1) {
  ...
  EXPECT_EQ(max_value.current_node->key, 23);
}
...
TEST(map_end, case2) {
  ...
  EXPECT_EQ(max_value.current_node->key, 11.400000001);
}
...
TEST(map_end, case3) {
  ...
  EXPECT_EQ(max_value.current_node->key, "hola-hola");
}
...
TEST(map_end, case5) {
  ...
  EXPECT_EQ(max_value.current_node->key, 1.4);
  EXPECT_EQ(max_value.current_node->value, "hello");
}
...
TEST(map_end, case6) {
  ...
  EXPECT_EQ(max_value.current_node->key, "hello");
  EXPECT_EQ(max_value.current_node->value, 1);
}
...
TEST(map_balance, case1) {
  ...
  EXPECT_EQ(max_value.current_node->key, 15);
  EXPECT_EQ(s21_map.size(), 3U);
}
...
TEST(map_balance, case2) {
  ...
  EXPECT_EQ(min_value.current_node->key, 11.4);
  EXPECT_EQ(s21_map.size(), 3U);
}
...
TEST(map_balance, case3) {
  ...
  EXPECT_EQ(min_value.current_node->key, "hola-hola");
...
TEST(map_balance, case4) {
  ...
  EXPECT_EQ(s21_map.end().current_node->key, 1543);
  EXPECT_EQ(s21_map.begin().current_node->key, 5);
  EXPECT_EQ(s21_map.size(), 5U);
}
...
TEST(map_balance, case5) {
  ...
  EXPECT_EQ(s21_map.end().current_node->key, 60);
  EXPECT_EQ(s21_map.begin().current_node->key, 1);
...
TEST(map_erase, case1) {
  ...
  ++it;
  s21_map.erase(it);
  EXPECT_EQ(s21_map.begin().current_node->key, 4);
  EXPECT_EQ(s21_map.end().current_node->key, 18);
  ...
  s21_map.erase(it);
  EXPECT_EQ(s21_map.begin().current_node->key, 5);
  EXPECT_EQ(s21_map.end().current_node->key, 16);
  EXPECT_EQ(s21_map.size(), 3U);
...
TEST(map_erase, case4) {
  ...
  s21_map.erase(it);
  it = s21_map.end();
  EXPECT_EQ(it.current_node->key, 941.44);
  EXPECT_EQ(s21_map.size(), 4U);
  ...
  ++it;
  ++it;
  EXPECT_EQ(s21_map.end().current_node->key, 44.48);
  EXPECT_EQ(s21_map.size(), 3U);
}
...
TEST(map_erase, case8) {
  ...
  it = s21_map.begin();
  ++it;
  EXPECT_EQ(it.current_node->key, 22.2);
  EXPECT_EQ(s21_map.size(), 3U);
}
...
TEST(map_erase, case9) {
  ...
  ++it;
  ++it;
  EXPECT_EQ(it.current_node->key, 40.54);
...
TEST(map_swap, case1) {
  ...
  EXPECT_EQ(s21_map_ref.begin().current_node->key, 1.44);

  EXPECT_EQ(s21_map_res.size(), 2U);
  EXPECT_EQ(s21_map_res.begin().current_node->key, 22.2);
}
